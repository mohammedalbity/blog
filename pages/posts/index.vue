<template>
  ...
  <Dialog v-model:visible="visibleEdit" modal header="Edit Post" class="w-fit">
    <Form @submit="handleUpdate">
      ...
      <div class="flex items-center gap-4 mb-8">
        <Select v-model="editPost.category_id" option-value="id" :options="storeCate.categories" optionLabel="name"
                placeholder="Select a Cate"
                class="w-full md:w-56"/>
      </div>
      <div class="flex items-center gap-4 mb-8">
        <label for="file-upload"
          ...
          <svg v-if="!editPost.image" class="w-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
            <g id="SVGRepo_iconCarrier">
              <path d="M12 15L12 2M12 2L15 5.5M12 2L9 5.5" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"
