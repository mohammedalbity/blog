<template>
    ...
    <Dialog v-model:visible="visibleEdit" modal header="Edit User" class="min-w-[500px]">
        <Form @submit="handleUpdate">
            ...
            <label for="password" class="font-semibold">Password</label>
            <div class="flex gap-4 mb-4">
                <InputText id="password" type="password" v-model="editUser.password" class="flex-auto"
                           autocomplete="off"/>
            </div>
            <label for="phone" class="font-semibold">Phone</label>
            <div class="flex gap-4 mb-4">
            ...
            <div class="flex items-center gap-4 mb-8">
                <div
                    ...
                    <label for="file-upload"
                           class="cursor-pointer  text-white px-4 py-2 rounded-md transition">
                        <Image v-if="editUser.avatar||avatar!=null" :src="avatar  ? avatar  : editUser.avatar"
                               alt="Image"
                               width="250"
                               preview/>
                    ...
                    <template #header>
                        <div class="flex justify-end">
                            <IconField>
                                ...
                                <InputText @input="()=>store.fetchUsers(1, store.searchQuery)"
                                           v-model.live.trim="store.searchQuery"
